...
@section('content')
    <div class="container">
       ...
       <p> Welcome to Sabifix! We're thrilled to have you on board. Thank you for confirming your email address and joining our community.</p>
       <p>At Sabifix, we're dedicated to making your service/business registration experience seamless and rewarding. Here's what we offer:</p>
