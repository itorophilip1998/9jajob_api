                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="listing_address" id="listing_address" class="form-control" autofocus required value="{{ $listing->listing_address }}">
                                            
                                            <input type="hidden" name="address_longitude" id="listing_location_longitude" class="form-control" value="{{ $listing->address_longitude }}">

                                            <input type="hidden" name="address_latitude" id="listing_location_latitude" class="form-control" value="{{ $listing->address_latitude }}">
