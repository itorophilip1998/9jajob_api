...
@section('admin_content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="mb_10">
                <form action="{{ route('admin_listing_search') }}" method="get">
                    <div class="row">
                        <div class="col-md-4">
                            <input type="text" name="listing_name" class="form-control" placeholder="Listing Name" value="{{ $listing_name_search }}">
                        </div>
                        <div class="col-md-2">
                            <select name="listing_order" class="form-control">
                                <option value="asc" @if($listing_order_search == 'asc') selected @endif>Ascending</option>
                                <option value="desc" @if($listing_order_search == 'desc') selected @endif>Descending</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                            <button type="submit" class="btn btn-primary h_34"><i class="fas fa-search"></i></button>
                        </div>
                    </div>
                </form>
            </div>
            <div class="table-responsive">
                <table class="table table-bordered" id="" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $loop->iteration + $listing->firstItem() - 1 }}</td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div>{{ $row->rListingCategory->listing_category_name }}</div>
                </div>

                <div class="form-group">
                    <label for="">{{ LISTING_LOCATION }}</label>
                    <div>{{ $row->listing_address }}</div>
                </div>
